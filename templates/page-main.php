...
/**
 * Template Name: Page Main: DESIGN - MADE
 *
...
?>
    ...
    <div class="page__content">
        <div class="container">
            <div class="about-heading d-none d-xl-block" style="background: linear-gradient(45deg, <?= $bannerColor1 ?>,<?= $bannerColor2 ?>)">
                <div class="d-flex justify-content-between xl:mb-2 xl:pb-1">
            ...
            if (have_rows('items')):  ?>
                <div class="home-nav pt-0 pt-xl-2 pb-3">
                    ...
                    ?>
                        <div class="home-nav__item <?php echo ($bannerSlider) ? 'has-slider' : '' ?> <?= $style ?>">
                            <div class="card rounded-0 border-0 mb-2 text-white <?= ($style == 'style3') ? '-link' : "" ?> wow fadeInUp" style="background: <?= $get_color ?>">
                                <?php if ($bannerSlider): ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card__excerpt mt-1 mb-0 d-none d-xl-block"><?= $get_excerpt ?></div>

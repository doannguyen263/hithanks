              ...
              <form id="order-apartment-form" class="order-form">
                ...
                <div id="order-detail-design" class="el-box js-order-detail-design js-page-order">
                  ...
                  <div class="mb-3">
                    ...
                    ?>
                        <div class="row mb-3" data-order-detail-group="<?= $id ?>">
                          <div class="col-md-3">
                            <label class="d-flex align-items-center gap-2 mb-2">
                              <div class="checkbox-wrapper-30">
                                <span class="checkbox">
                                  <input type="checkbox" class="js-select-all-items" data-group-id="<?= $id ?>" />
                                  <svg>
                                ...
                                <div class="row mb-3">
                                  <div class="col-md-9">
                                    <label class="d-flex align-items-center gap-1 mb-1">
                                      <div class="checkbox-wrapper-30">
                                        <span class="checkbox">
                                          <input type="checkbox" name="order_detail_items[]" value="order_detail_item_<?= $id . '-' . $id_menu ?>" data-name="<?= esc_attr($name) ?>" data-group-id="<?= $id ?>" class="js-order-detail-item" <?= $default_checked ? 'checked' : '' ?> />
                                          <svg>
                                            <use xlink:href="#checkbox-30" class="checkbox"></use>
                                          </svg>
                                        </span>
                ...
                <p><strong>3/3. Xem và gửi yêu cầu</strong></p>
                <div class="el-box">
